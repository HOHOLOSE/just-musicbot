...
module.exports = async (client) => {
    ...
    let embed = new EmbedBuilder()
      ...
      .setImage (
        guild.banner
          ...
          : `https://cdn.discordapp.com/attachments/1143691931281543303/1147754856057163906/standard_1.gif`
      );
  ...
  client.playembed = (guild) => {
    ...
    .setDescription(
        ` >>> **รองรับ <:Youtube:1147749037420839054> , <:Spotify:1147749045805264916> 
       <:discord:1147749770287382579> | เข้าดิส :** [น้อง ᴏʀᴇᴏ](${client.config.links.Website})
       <:instagram:1147749053107552348> **| ติดตาม :** [instagram](${client.config.links.DiscordServer})`
      )
      
      .setImage(
        guild.banner
          ? guild.bannerURL({ size: 4096 })
          : `https://cdn.discordapp.com/attachments/1143691931281543303/1147757530760626197/IMG_0422.jpg`
      )
