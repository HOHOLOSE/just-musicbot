module.exports = {
  TOKEN: process.env.TOKEN || "MTE0NzE3NzE4NDEyMTg2ODQyOA.GejQEw.XtkjBznVUJWq5SS3vkXEKUTyDlYY08Z_m7vm7s",
  PREFIX: process.env.PREFIX || "f1",
  embed: {
    color: process.env.color || "d752de",
    wrongcolor: process.env.wrongcolor || "d752de",
    footertext: "ขอให้คุณสนุกกับการฟังเพลง",
  },
  emoji: {
    ERROR: "❌",
    SUCCESS: "✅",
  ...
  links: {
    ...
    DiscordServer: process.env.DiscordServer || `https://www.instagram.com`,
